...
export const HARD_STOPS = [
  { id: 'protected_class', label: 'Protected-class treatment or bias', desc: 'Conduct or a complaint touching race, color, religion, sex, national origin, age (40+), disability, pregnancy, genetic info, or other protected status.', route: ['EOA', 'EC'], law: 'Title VII, ADEA, ADA, GINA, PDA (+ FCRA in FL, FEHA in CA, NYSHRL in NY)' },
  ...
  { id: 'student_involved', label: 'A student is involved', desc: 'The situation involves a student in any capacity — as a party, witness, or subject.', route: ['EOA'], law: 'EOA owns anything involving a student' },
  { id: 'disability_accommodation', label: 'Disability or accommodation signal', desc: 'A stated or apparent disability, an accommodation request, or conduct that may stem from a medical condition.', route: ['ER', 'EC'], law: 'ADA / ADAAA — interactive process required (FEHA in CA is broader)' },
  { id: 'leave_interference', label: 'Leave or medical interference', desc: "Anything touching FMLA, parental, medical, military, or workers' comp leave — including discipline timed near a leave request.", route: ['ER', 'EC'], law: 'FMLA, USERRA, workers’ comp anti-retaliation (CFRA in CA)' },
  { id: 'concerted_activity', label: 'Concerted or protected activity', desc: 'Group complaints about pay or conditions, union activity, whistleblowing, or reporting a legal/safety violation.', route: ['ER', 'EC'], law: 'NLRA §7; whistleblower statutes (esp. FL §448.101)' },
